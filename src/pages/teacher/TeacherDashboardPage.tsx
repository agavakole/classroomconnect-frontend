...
export function TeacherDashboardPage() {
  ...
  const isLoading =
    coursesQuery.isLoading || surveysQuery.isLoading || activitiesQuery.isLoading;

  // Helper function to get mood color
  const getMoodColor = (mood: string) => {
    const moodLower = mood?.toLowerCase() || "";
    if (moodLower.includes("happy") || moodLower.includes("excited") || moodLower.includes("great"))
      return "green";
    if (moodLower.includes("calm") || moodLower.includes("focused") || moodLower.includes("good"))
      return "blue";
    if (moodLower.includes("tired") || moodLower.includes("sleepy"))
      return "orange";
    if (moodLower.includes("sad") || moodLower.includes("anxious") || moodLower.includes("stressed"))
      return "red";
    return "purple";
  };
      ...
      <SimpleGrid columns={{ base: 1, xl: 3 }} spacing={6} alignItems="start">
        ...
        <Box gridColumn={{ xl: "span 2" }}>
          <Stack spacing={6}>
                    ...
                    <CardBody p={{ base: 4, md: 6 }}>
                      <VStack align="flex-start" spacing={3}>
                        <Box bg={stat.iconBg} p={2} borderRadius="lg">
                          <Icon as={stat.icon} boxSize={5} color={stat.iconColor} />
                        </Box>
            ...
            <Card borderRadius="2xl" boxShadow="sm" bg="white" overflow="hidden" border="none">
              <CardHeader pb={3}>
                <Flex 
                  ...
                  <HStack spacing={3}>
                    ...
                    {activeSessions > 0 && (
                      <Badge
                        ...
                        gap={1}
                      >
                        <Box as="span" w="6px" h="6px" borderRadius="full" bg="green.500" />
                        Live
                      </Badge>
                    )}
                  </HStack>
              ...
              <CardBody pt={0}>
                {submissionsQuery.isLoading || sessionsQueries.isLoading ? (
                            ...
                            <VStack align="flex-start" spacing={1} flex="1" minW="0">
                              ...
                              <Wrap spacing={2}>
                                ...
                                {submission.mood && (
                                  <WrapItem>
                                    <Badge
                                      colorScheme={getMoodColor(submission.mood)}
                                      borderRadius="full"
                                      px={2}
                                      py={0.5}
                                      fontSize="2xs"
                  ...
                  <VStack py={8} spacing={3}>
                    ...
                    <Text color="gray.500" fontSize="xs" textAlign="center" maxW="300px">
                      Students will appear here once they complete their check-in
                    </Text>
                  </VStack>
                ) : (
                  <VStack py={8} spacing={3}>
                  ...
                  {coursesQuery.isLoading ? (
                    ...
                    <VStack spacing={2} align="stretch">
                      {coursesQuery.data.slice(0, 4).map((course: any) => (
                        ...
                        >
                          <HStack spacing={3} flex="1" minW="0">
                            <Box bg="brand.100" p={2} borderRadius="lg" flexShrink={0}>
                          ...
                          <Icon as={FiArrowRight} color="gray.400" flexShrink={0} />
                        </HStack>
                      ))}
                    </VStack>
                  ) : (
                  ...
                  <>
                        ...
                        >
                          <HStack spacing={3} flex="1" minW="0">
                            <Box
                              ...
                              flexShrink={0}
                            >
                              <Icon as={FiGrid} boxSize={5} color="purple.500" />
                            </Box>
                            <VStack align="flex-start" spacing={1} flex="1" minW="0">
                              <Text
                                fontWeight="700"
                    ...
                    <Box display={{ base: "none", md: "block" }}>
                      <Table variant="simple" size="sm">
                        <Thead>
                          <Tr>
                            <Th color="gray.500" fontWeight="600" fontSize="xs" textTransform="uppercase">
                              #
                            </Th>
                            <Th color="gray.500" fontWeight="600" fontSize="xs" textTransform="uppercase">
                              Activity
                ...
                <SimpleGrid columns={7} spacing={1}>
                  ...
                  {calendarDays.map((day, i) => (
                    <Flex
                      ...
                      color={
                        day === todayDate && isCurrentMonth ? "white" : "gray.700"
                      }
                      fontWeight={day === todayDate && isCurrentMonth ? "700" : "500"}
                      fontSize="sm"
